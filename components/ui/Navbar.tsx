...
const Navbar: React.FC = () => {
    ...
    return (
        <nav className="flex flex-row justify-between w-full px-8 md:px-[11.25%] py-4 bg-[#96c1e9]/30 shadow-text drop-shadow-lg items-center">
            ...
            <div className="flex md:hidden flex-col bottom-8 top-12 justify-end items-center align-middle">
                ...
                {isOpen && (
                <div className="flex flex-col absolute top-10 right-0 gap-y-4 bg-primary m-8 p-4 rounded-md z-10">
                    {NavLinks.map((link, index) => (
