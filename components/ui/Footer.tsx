...
const Footer: React.FC = () => {
    return (
        <div className="flex flex-col overflow-x-hidden">
            ...
            <footer className="flex flex-col md:flex-row items-center justify-between w-full px-8 md:px-[11.25%] bg-[#d2e7fa] shadow-text drop-shadow-lg pt-4 pb-8 mt-auto gap-y-6">
